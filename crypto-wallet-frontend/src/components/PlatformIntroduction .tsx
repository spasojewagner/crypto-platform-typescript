      ...
      <div className="max-w-5xl mx-auto bg-gray-800 rounded-2xl shadow-lg overflow-hidden md:flex">
        ...
        <div className="p-6 flex-1">
          ...
          <div className="text-gray-300 space-y-4">
            <p>
              Raven Global Professional Station, an innovative digital asset trading platform 
              ...
              it is operated by the Raven global professional station team.
            </p>
            <p>
              Raven is the world's leading blockchain asset financial service provider. It has 
            ...
            <p>
           Raven and its sub-brands are in a leading position in the world in terms of 
